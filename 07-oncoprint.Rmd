...
use similar graphics because they are snvs and we want them visually similar, while we add
...
"exonic". On the barplots which summarize the number of different alteration types, we don't want to
...
or exonic. If there is no "intronic" or "exonic" attached for the gene, it basically means we don't
have this gene-related information (maybe it is a intergenic snv/indel).
...
means the number of intronic snv plus exonic snv).
