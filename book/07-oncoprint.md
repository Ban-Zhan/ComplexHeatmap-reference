...
<a href="http://www.cbioportal.org/faq#what-are-oncoprints">OncoPrint</a> is a way to visualize
...
Now in `m`, there are four different alteration types: `snv`, `indel`, `intronic` and `exonic`. Next
