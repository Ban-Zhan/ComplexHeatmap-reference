...
```{r cluster_dendsort, fig.width = 14, echo = FALSE}
...
Heatmap(mat, name = "mat", row_split = cbind(rep(c("A", "B"), 12), cl))
```
...
```{r}
split = data.frame(rep(c("A", "B"), 12), rep(c("C", "D"), each = 12))
