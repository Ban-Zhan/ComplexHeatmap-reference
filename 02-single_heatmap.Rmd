...
pushViewport(viewport(x = 0, width = 1/3))
Heatmap(mat, name = "mat", col = col_fun, column_title = "mat", newpage = FALSE)
popViewport()
pushViewport(viewport(x = 1/3, width = 1/3))
Heatmap(mat/4, name = "mat", col = col_fun, column_title = "mat/4", newpage = FALSE)
popViewport()
pushViewport(viewport(x = 2/3, width = 1/3))
eatmap(abs(mat), name = "mat", col = col_fun, column_title = "abs(mat)", newpage = FALSE)
popViewport()
```
...
Note graphic settings `row_dend` will be overwritten by `row_dend_param`.

```{r}
Heatmap(mat, name = "mat", cluster_rows = row_dend, row_dend_param = gpar(col = "red"))
```
