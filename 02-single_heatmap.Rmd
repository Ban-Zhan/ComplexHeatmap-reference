...
Heatmap(mat, name = "mat1", col = f1, column_title = "LAB color space", newpage = FALSE)
upViewport()
pushViewport(viewport(x = 0.5, width = 0.5, just = "left"))
Heatmap(mat, name = "mat2", col = f2, column_title = "RGB color space", newpage = FALSE)
upViewport()
```
...
```{r, echo = FALSE}
pushViewport(viewport(x = 0, width = 0.5, just = "left"))
Heatmap(mat, name = "mat", column_names_rot = 45, newpage = FALSE)
upViewport()
pushViewport(viewport(x = 0.5, width = 0.5, just = "left"))
Heatmap(mat, name = "mat", column_names_rot = 45, column_names_side = "top",
