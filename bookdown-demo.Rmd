...
annotation_width = function(ha) {
    if(identical(width(ha), unit(1, "npc"))) {
        6
    } else {
        convertWidth(width(ha) + unit(4, "mm"), "inch", valueOnly = TRUE)
    }
}
annotation_height = function(ha) {
    if(identical(height(ha), unit(1, "npc"))) {
        6
    } else {
        convertHeight(height(ha) + unit(4, "mm"), "inch", valueOnly = TRUE)
    }
}
```
...
<!--chapter:end:03-heatmap_annotation.Rmd-->
...
<!--chapter:end:08-other-high-level-plots.Rmd-->
